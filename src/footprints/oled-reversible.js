...
(module OLED-128x32-double-sided (layer F.Cu) (tedit 61D90230)
  ...
  ${"" /* footprint reference */}
  (fp_text reference "${p.ref}" (at 3 6 ${p.rot}) (layer "F.SilkS") ${p.ref_hide
            }
  ...
  (pad "1" smd custom (at 3.251 9.8 ${p.rot
  ...
  (pad "1" smd custom (at 3.251 2.18  ${p.rot + 180
  ...
  (pad "2" smd custom (at 3.251 7.26 ${p.rot
            }) (size 1 0.7) (layers "${side}.Cu" "${side}.Mask")
    (zone_connect 2)
    (options (clearance outline) (anchor rect))
    (primitives
  ...
  (pad "2" smd custom (at 3.251 4.72 ${p.rot + 180
            }) (size 1 0.7) (layers "${reverseSide}.Cu" "${reverseSide}.Mask")
    (zone_connect 2)
    (options (clearance outline) (anchor rect))
    (primitives
  ...
  (pad "3" smd custom (at 3.251 7.26 ${p.rot + 180
            }) (size 1 0.7) (layers "${reverseSide}.Cu" "${reverseSide}.Mask")
    (zone_connect 2)
    (options (clearance outline) (anchor rect))
    (primitives
  ...
  (pad "3" smd custom (at 3.251 4.72 ${p.rot
            }) (size 1 0.7) (layers "${side}.Cu" "${side}.Mask")
    (zone_connect 2)
    (options (clearance outline) (anchor rect))
    (primitives
  ...
  (pad "4" smd custom (at 3.251 2.18 ${p.rot
            }) (size 1 0.7) (layers "${side}.Cu" "${side}.Mask")
    (zone_connect 2)
    (options (clearance outline) (anchor rect))
    (primitives
  ...
  (pad "4" smd custom (at 3.251 9.8 ${p.rot + 180
            }) (size 1 0.7) (layers "${reverseSide}.Cu" "${reverseSide}.Mask")
    (zone_connect 2)
    (options (clearance outline) (anchor rect))
    (primitives
  ...
  (pad "5" thru_hole rect (at 1.6 9.8 ${p.rot + 180
            }) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) (tstamp f95a62fe-372a-4ed7-bc60-48b69f9f1239))
  (pad "6" thru_hole roundrect (at 1.6 7.26 ${p.rot + 180
  ...
  (pad "7" thru_hole roundrect (at 1.6 4.72 ${p.rot + 180
            }) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) (roundrect_rratio 0.5)
    (chamfer_ratio 0) (chamfer top_left bottom_left) (tstamp db1bc6ad-27ca-48cd-85e5-ce0970823817))
  (pad "8" thru_hole roundrect (at 1.6 2.18 ${p.rot + 180
            }) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) (roundrect_rratio 0.5)
