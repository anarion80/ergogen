module.exports = {
    ...
    (fp_text user "${p.P1.name}" (at -0 3.4 ${p.rot}) (layer "${side}.SilkS") (tstamp a4214d03-071c-4bd6-b5fa-32f45a71db92)
      (effects (font (size 0.5 0.5) (thickness 0.2)) (justify ${mirror}))
    )

    (fp_text user "${p.P2.name}" (at 2 3.4 ${p.rot}) (layer ${side}.SilkS) (tstamp a4214d03-071c-4bd6-b5fa-32f45a71db92)
      (effects (font (size 0.5 0.5) (thickness 0.2)) (justify ${mirror}))
    )

    (fp_text user "${p.P3.name}" (at 4 3.4 ${p.rot}) (layer ${side}.SilkS) (tstamp a4214d03-071c-4bd6-b5fa-32f45a71db92)
      (effects (font (size 0.5 0.5) (thickness 0.2)) (justify ${mirror}))
    )

    (fp_text user "${p.P4.name}" (at 6 3.4 ${p.rot}) (layer ${side}.SilkS) (tstamp a4214d03-071c-4bd6-b5fa-32f45a71db92)
      (effects (font (size 0.5 0.5) (thickness 0.2)) (justify ${mirror}))
    )
...
`;
  ...
  (module JST_PH_S2B-PH-K_02x2.00mm_Angled (layer F.Cu) (tedit 58D3FE32)
    ...
    (attr through_hole)
      ...
      (pad "1" thru_hole roundrect (at 0 0 ${p.rot
            }) (size 1.2 1.75) (drill 0.75) (layers *.Cu *.Mask) ${p.P1.str
            } (roundrect_rratio 0.208333) (tstamp b18d9740-6393-4c71-8d12-9c787ecb0afa))
      (pad "2" thru_hole oval (at 2 0 ${p.rot
            }) (size 1.2 1.75) (drill 0.75) (layers *.Cu *.Mask) ${p.P2.str
            } (tstamp 889d9794-9d31-470c-99ff-01354b41ba19))
      (pad "3" thru_hole oval (at 4 0 ${p.rot
            }) (size 1.2 1.75) (drill 0.75) (layers *.Cu *.Mask) ${p.P3.str
            } (tstamp f87f91d5-c926-4a4d-92fa-a2ad71cc3d8c))
      (pad "4" thru_hole oval (at 6 0 ${p.rot
            }) (size 1.2 1.75) (drill 0.75) (layers *.Cu *.Mask) ${p.P4.str
